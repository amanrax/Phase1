      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">👨‍💼 Operator Management</h1>
          </div>
          <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 flex gap-3 items-end flex-wrap">
          <div className="flex-1 min-w-64">
            ...
            <select
              ...
              className="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100 text-sm"
            >
          ...
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 overflow-y-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-2xl w-full my-8 max-h-[90vh] overflow-y-auto">
              <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-6 flex justify-between items-center">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">➕ Create New Operator</h2>
                <button
              ...
              <form onSubmit={handleCreate} className="p-6 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase">First Name <span className="text-red-500">*</span></label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase">Last Name <span className="text-red-500">*</span></label>
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase">Email <span className="text-red-500">*</span></label>
                    <input
                      type="email"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase">Password <span className="text-red-500">*</span></label>
                    <input
                      type="password"
                  ...
                  <div>
                    <label className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase">Confirm Password <span className="text-red-500">*</span></label>
                    <input
                      type="password"
        ...
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-4">Loading operators...</p>
          </div>
        ) : error ? (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-12 text-center">
            <p className="text-red-600 text-lg">{error}</p>
            <p className="text-gray-500 dark:text-gray-500 dark:text-gray-500 text-sm">Try refreshing or check your network/API.</p>
          </div>
        ) : operators.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-12 text-center">
            <p className="text-gray-600 dark:text-gray-400 text-lg">No operators found</p>
            <p className="text-gray-500 dark:text-gray-500 dark:text-gray-500 text-sm">Create a new operator to get started</p>
          </div>
        ) : (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  {filteredOperators.map((operator) => (
                    <tr key={operator._id} className="hover:bg-green-50 transition">
                      <td className="px-6 py-4 font-semibold text-gray-800 dark:text-gray-100">{operator.operator_id || "N/A"}</td>
              ...
              {filteredOperators.map((operator) => (
                <div key={operator._id} className="p-4 hover:bg-green-50 transition space-y-3">
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase">ID</p>
                      <p className="font-semibold text-gray-800 dark:text-gray-100">{operator.operator_id || "N/A"}</p>
                    </div>
                    <span className={`px-3 py-1 text-xs font-semibold rounded-full ${
                      operator.is_active 
                        ? "bg-green-100 text-green-800" 
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase">Name</p>
                      <p className="text-gray-800 dark:text-gray-100">{operator.full_name || "Unknown"}</p>
                    </div>
                    <div>
                      <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase">Email</p>
                      <p className="text-gray-700 dark:text-gray-300">{operator.email || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase">Phone</p>
                      <p className="text-gray-700 dark:text-gray-300">{operator.phone || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase">District</p>
                      <p className="text-gray-700 dark:text-gray-300">{getDistrictDisplayName(operator.assigned_district || operator.assigned_districts?.[0])}</p>
                    </div>
                  </div>
            ...
            {/* Pagination */}
            <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 flex justify-between items-center text-xs text-gray-600 dark:text-gray-400">
        ...
        {showViewModal && selectedOperator && (
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-6 flex justify-between items-center">
                <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100">👁️ Operator Details</h2>
                <button
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex justify-between items-start pb-4 border-b border-gray-200 dark:border-gray-700">
                  <div>
                    <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase mb-1">Operator ID</p>
                    <p className="text-2xl font-bold text-gray-800 dark:text-gray-100">{selectedOperator.operator_id || "N/A"}</p>
                  </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase mb-1">Full Name</p>
                      <p className="text-gray-800 dark:text-gray-100">{selectedOperator.full_name || "Unknown"}</p>
                    </div>
                    <div>
                      <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase mb-1">Email</p>
                      <p className="text-gray-800 dark:text-gray-100 break-all">{selectedOperator.email || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase mb-1">Phone</p>
                      <p className="text-gray-800 dark:text-gray-100">{selectedOperator.phone || "N/A"}</p>
                    </div>
                    {selectedOperator.user_id && (
                      <div>
                        <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase mb-1">User ID</p>
                        <p className="text-gray-600 dark:text-gray-400 text-xs font-mono">{selectedOperator.user_id}</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase mb-1">Assigned Districts</p>
                      {selectedOperator.assigned_districts && selectedOperator.assigned_districts.length > 0 ? (
                        ...
                        <p className="text-gray-500 dark:text-gray-500 dark:text-gray-500 text-sm">No districts assigned</p>
                      )}
                    </div>
                    <div>
                      <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase mb-1">Assigned Regions</p>
                      {selectedOperator.assigned_regions && selectedOperator.assigned_regions.length > 0 ? (
                        ...
                        <p className="text-gray-500 dark:text-gray-500 dark:text-gray-500 text-sm">No regions assigned</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-600">
                      <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase mb-1">Registered Farmers</p>
                      <p className="text-2xl font-bold text-gray-800 dark:text-gray-100">{selectedOperator.farmer_count ?? 0}</p>
                    </div>
                    <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                      <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase mb-1">Account Status</p>
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {selectedOperator.created_at && (
                      <div>
                        <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase mb-1">Created At</p>
                    ...
                    {selectedOperator.updated_at && (
                      <div>
                        <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase mb-1">Last Updated</p>
                        <p className="text-gray-800 dark:text-gray-100 text-sm">
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700 flex gap-2">
                  ...
                  <button
                    onClick={() => setShowViewModal(false)}
                    className="flex-1 bg-gray-300 hover:bg-gray-400 text-gray-800 dark:text-gray-100 font-bold py-3 px-4 rounded-lg transition"
                  >
                    Close
                  </button>
                </div>
        ...
        {showEditModal && selectedOperator && (
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 overflow-y-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full my-8 max-h-[90vh] overflow-y-auto">
              <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-6 flex justify-between items-center">
                <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100">✏️ Edit Operator</h2>
                <button
              ...
              <form onSubmit={handleEditSubmit} className="p-6 space-y-4">
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                  <p className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase mb-2">Change Password (Optional)</p>
                  <p className="text-xs text-gray-500 dark:text-gray-500 dark:text-gray-500 mb-3">Leave blank to keep current password</p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase">New Password</label>
                      <input
                        type="password"
                    ...
                    <div>
                      <label className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase">Confirm New Password</label>
                      <input
                        type="password"
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                  <label className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase mb-2 block">Status</label>
