    ...
    <div className="h-16 bg-white dark:bg-gray-800 shadow-sm flex items-center justify-between px-4 sm:px-6 sticky top-0 z-20">
      ...
      <div className="flex items-center gap-4 flex-1">
        ...
        <button 
          ...
          className="md:hidden flex items-center justify-center w-10 h-10 hover:bg-gray-100 dark:bg-gray-700 rounded-lg transition-colors"
        >
          <i className={`fa-solid ${sidebarOpen ? 'fa-xmark' : 'fa-bars'} text-xl text-gray-700 dark:text-gray-300`}></i>
        </button>

        {/* Title */}
        {title && <h2 className="text-lg sm:text-xl font-bold text-gray-800 dark:text-gray-100 truncate">{title}</h2>}
      </div>
