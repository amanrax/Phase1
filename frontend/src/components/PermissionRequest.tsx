      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl max-w-md w-full p-6 shadow-2xl">
        ...
        <div className="space-y-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white">Camera</h3>
        ...
        <p className="text-xs text-gray-500 dark:text-gray-500 dark:text-gray-500 text-center mt-3">
